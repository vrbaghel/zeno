...
class MemContext(BaseModel):
    session_summary: str
    relevant_traces: list[MemTrace] = Field(default_factory=list)
    agent_logs: list[MemTrace] = Field(default_factory=list)
