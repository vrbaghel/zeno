"""
Run: `python -m chanakya.db.smoke_test`

Uses a temporary SQLite file; does not touch the default cwd-based database (./.chanakya/chanakya.db).
"""
...
async def main() -> None:
    ...
    os.close(fd)
    os.environ["CHANAKYA_DATABASE_URL"] = f"sqlite+aiosqlite:///{path}"
    ...
    from chanakya.db.repository import complete_task
