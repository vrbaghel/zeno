...
from chanakya.core.mode import AdapterStatus, ApiKeyStatus, ModeSource, OperationMode
...
def print_adapter_startup(
    *,
    ...
    console.print(f"Chanakya v{ctx.version}")
    console.print("─" * 34)
...
def print_api_missing_keys_error(
    *,
    ...
    console.print()
    console.print("Set a key with: chanakya config set openai-key <key>")
    console.print("─" * 34)
